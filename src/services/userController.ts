...
export const registerUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => { // funcao para registrar um novo usuario 
    try {
        ...
        const user = await prisma.user.create({ // Cria um novo usuário no banco de dados com as informações fornecidas.
